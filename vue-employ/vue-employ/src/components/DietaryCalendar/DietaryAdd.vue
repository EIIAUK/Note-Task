...
<script>
    ...
    export default {
        ...
        created(){
            this.host = HOST
            let url = `${HOST}/dietary/selAll`
            axios.get(url).then(res=>{
                this.dietaryOpt = res.data
                console.log(this.dietaryOpt)
            })
        },
        methods:{
            onSubmit(formName){
